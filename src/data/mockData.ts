...
export const initialInvoices: InvoiceRecord[] = [
  ...
  {
    id: 'inv-petrol-1',
    supplierName: 'Shell Ultra City Midrand (N1 North)',
    vatNumber: '4450192834',
    invoiceNumber: 'SHL-MID-4402',
    date: '2026-06-20',
    category: 'Motor Vehicle Fuel & Petrol',
    totalAmount: 1450.00,
    vatAmount: 0.00, // Fuel levy zero-rated for VAT in SA
    netAmount: 1450.00,
    sarsSection: 'Section 11(a) Travel Expense',
    isVatClaimable: false,
    isDeductible: true,
    explanation: 'Shell N1 Highway Midrand Ultra City fuel purchase corroborating Sandton to Pretoria business journey. Zero-rated fuel levy.',
    confidence: 0.99,
    syncedToSarsReport: true,
    isPetrolInvoice: true,
    stationName: 'Shell Ultra City Midrand N1',
    stationLatitude: -25.9860,
    stationLongitude: 28.1250,
    litresPurchased: 61.5
  },
  {
    id: 'inv-petrol-2',
    supplierName: 'Sasol Rosebank Convenience Centre',
    vatNumber: '4029182374',
    invoiceNumber: 'SAS-RSB-901',
    date: '2026-06-22',
    category: 'Motor Vehicle Fuel & Petrol',
    totalAmount: 980.00,
    vatAmount: 0.00,
    ...
    isVatClaimable: false,
    isDeductible: true,
    explanation: 'Sasol Oxford Rd Rosebank refuel corroborated on Rosebank to Centurion corridor.',
    confidence: 0.97,
    syncedToSarsReport: true,
    isPetrolInvoice: true,
    stationName: 'Sasol Oxford Rd Rosebank',
    stationLatitude: -26.1450,
    stationLongitude: 28.0440,
    litresPurchased: 41.2
  },
  {
    id: 'inv-petrol-3',
    supplierName: 'Engen 1-Stop Durban Southbound (Out of Route)',
    vatNumber: '4820194821',
    invoiceNumber: 'ENG-DBN-771',
    date: '2026-06-20',
    category: 'Motor Vehicle Fuel & Petrol',
    totalAmount: 1200.00,
    vatAmount: 0.00,
    ...
    isVatClaimable: false,
    isDeductible: true,
    explanation: 'Engen N3 KwaZulu-Natal Durban corridor refuel. Station location exceeds Johannesburg-Pretoria route boundaries.',
    confidence: 0.94,
    syncedToSarsReport: false,
    isPetrolInvoice: true,
    stationName: 'Engen N3 Durban 1-Stop',
    stationLatitude: -29.8587,
    stationLongitude: 31.0218,
    litresPurchased: 50.0
  }
];
